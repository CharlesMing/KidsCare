 ...
 * 
 */
public class CourseFridayActivity extends Activity {
	@SuppressWarnings("unused")
	private static final String TAG = "CourseFridayActivity";
						...
						try {
							...
							if (course.getAm() == null) {
								...
								SimpleAdapter listItemAdapteram = new SimpleAdapter(
										CourseFridayActivity.this, anListItem,
										R.layout.courseitem,
								...
								SimpleAdapter listItemAdapterpm = new SimpleAdapter(
										CourseFridayActivity.this, pnListItem,
										R.layout.courseitem,
