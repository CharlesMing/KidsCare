 ...
 * 
 */
public class CourseTuesdayActivity extends Activity {
	@SuppressWarnings("unused")
	private static final String TAG = "CourseTuesdayActivity";
					...
					public void run() {
						try {
							...
							SimpleAdapter listItemAdapteram = new SimpleAdapter(
									CourseTuesdayActivity.this, anListItem,
									R.layout.courseitem,
							...
							SimpleAdapter listItemAdapterpm = new SimpleAdapter(
									CourseTuesdayActivity.this, pnListItem,
									R.layout.courseitem,
