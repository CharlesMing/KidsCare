...
public class FoodMondayActivity extends Activity {
	private static final String TAG = "FoodMondayActivity";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		dialog = new ProgressDialog(FoodMondayActivity.this);
		initView();
		initData();
	...
	public void initData() {
		...
		try {
			...
			Log.v(TAG, "strBreakfast----->>" + breakfasts);
