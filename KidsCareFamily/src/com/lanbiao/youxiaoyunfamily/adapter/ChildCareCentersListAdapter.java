...
public class ChildCareCentersListAdapter extends ArrayAdapter<BabyStudyRaise>
	...
	public ChildCareCentersListAdapter(Context context,
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		ImageLoaderInfo info = new ImageLoaderInfo(imgUrl, holder.img_id, null,// 图片双缓存
				ChildCareCentersListAdapter.this);
